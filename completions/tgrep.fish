...
complete -c tgrep -l searcher -d 'executable to do the searching' -r -f -a "rg\t''
tgrep\t''"
...
rounded\t''
none\t''"
complete -c tgrep -l editor -d 'command used to open selections' -r
complete -c tgrep -l open-like -d 'command line syntax for opening a file at a line' -r -f -a "vi\t''
hx\t''
code\t''
jed\t''
default\t''"
...
powershell\t''
zsh\t''"
complete -c tgrep -l selection-file -d 'file to write selection to (first line: file path, second line: line number if applicable)' -r -F
complete -c tgrep -l repeat-file -d 'file where arguments are saved' -r -F
...
complete -c tgrep -l plugin-support
complete -c tgrep -s . -l hidden -d 'search hidden files'
complete -c tgrep -l repeat -d 'repeats the last saved search'
...
complete -c tgrep -l overview -d 'conclude results with an overview'
complete -c tgrep -s s -l select -d 'results are shown in a selection interface for opening'
complete -c tgrep -l menu -d 'provide arguments and select result through an interface'
