...
set edit:completion:arg-completer[tgrep] = {|@words|
    ...
    var completions = [
        &'tgrep'= {
            ...
            cand --selection-file 'file to write selection to (first line: file path, second line: line number if applicable)'
            cand --repeat-file 'file where arguments are saved'
            ...
            cand --plugin-support 'plugin-support'
            cand -. 'search hidden files'
            cand --hidden 'search hidden files'
            cand --repeat 'repeats the last saved search'
            ...
            cand -s 'results are shown in a selection interface for opening'
            cand --select 'results are shown in a selection interface for opening'
            cand --menu 'provide arguments and select result through an interface'
