...
Register-ArgumentCompleter -Native -CommandName 'tgrep' -ScriptBlock {
    ...
    $completions = @(switch ($command) {
        'tgrep' {
            ...
            [CompletionResult]::new('--selection-file', '--selection-file', [CompletionResultType]::ParameterName, 'file to write selection to (first line: file path, second line: line number if applicable)')
            [CompletionResult]::new('--repeat-file', '--repeat-file', [CompletionResultType]::ParameterName, 'file where arguments are saved')
            ...
            [CompletionResult]::new('--plugin-support', '--plugin-support', [CompletionResultType]::ParameterName, 'plugin-support')
            ...
            [CompletionResult]::new('--repeat', '--repeat', [CompletionResultType]::ParameterName, 'repeats the last saved search')
            ...
            [CompletionResult]::new('-s', '-s', [CompletionResultType]::ParameterName, 'results are shown in a selection interface for opening')
            [CompletionResult]::new('--select', '--select', [CompletionResultType]::ParameterName, 'results are shown in a selection interface for opening')
            [CompletionResult]::new('--menu', '--menu', [CompletionResultType]::ParameterName, 'provide arguments and select result through an interface')
