...
Register-ArgumentCompleter -Native -CommandName 'tgrep' -ScriptBlock {
    ...
    $completions = @(switch ($command) {
        'tgrep' {
            ...
            [CompletionResult]::new('-f', '-f', [CompletionResultType]::ParameterName, 'don''t show matched content')
            [CompletionResult]::new('--files', '--files', [CompletionResultType]::ParameterName, 'don''t show matched content')
